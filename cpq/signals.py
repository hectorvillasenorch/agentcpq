...
from .custom_objects.custom_objects import create_defaults_fields_for_custom_objects, set_custom_indentifier
...
def create_default_fields_for_custom_object(sender, instance, created, **kwargs):
    if created:
        create_defaults_fields_for_custom_objects(instance)
