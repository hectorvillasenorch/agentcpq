...
def _extract_quote_line_to_delete_with_llm_legacy(user_message, current_state, previous_summary=None):
    """Legacy (unused): older delete-quote-line extraction logic kept for reference."""
