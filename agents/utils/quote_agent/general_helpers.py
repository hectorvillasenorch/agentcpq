...
def get_quote_details(quote):
    ...
    return {
        ...
        "account_id": quote.account_id if quote_details_settings.show_quote_account and quote.account else None,
        "opportunity": quote.opportunity.name if quote_details_settings.show_quote_opportunity and quote.opportunity else None,
        "opportunity_id": quote.opportunity_id if quote_details_settings.show_quote_opportunity and quote.opportunity else None,
