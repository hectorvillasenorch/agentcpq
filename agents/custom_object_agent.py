...
#LLM helpers
from agents.utils.custom_object_agent.llm_helpers import extract_custom_object_data, extract_custom_objects, extract_custom_fields

# Session Context Helpers
from .utils.orchestrator.context_handle_helpers import save_or_update_conversation_context, make_session_context

# Handle Helpers
from .utils.custom_object_agent.handle_helpers import handle_custom_object_creation, handle_custom_fields_creation, handle_custom_object_records
...
def custom_object_agent(user, action, user_message, session_data):
    ...
    action_map = {
        ...
        "CreateCustomObjectRecord": create_custom_object_record,
    }
...
def create_custom_object_record(user, user_message, session_data):
